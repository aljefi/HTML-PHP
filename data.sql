...
insert into authors
values (null, 'Elisabeth', 'Robson', 5); # 1
insert into authors
values (null, 'Eric', 'Freeman', 1); # 2
insert into authors
values (null, 'Aleksandr', 'Jefimov', 1); # 3
insert into books
values (null, 'Head First Html and CSS', 5, true);
insert into books
values (null, 'My Book', null, false);
insert into books
values (null, 'AAA', null, false);
insert into books
values (null, 'BBB', null, false);
